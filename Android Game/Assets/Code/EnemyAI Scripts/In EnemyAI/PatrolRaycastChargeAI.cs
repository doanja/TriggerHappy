...
/*
* Resource: Adapted from PatrolRaycastShootAI
*
* This class will move the GameObject back and forth between two platforms, changing
* direction upon collision with the platform. This GameObject will double its
* MovementSpeed if raycast detected the Player.
*/
public class PatrolRaycastChargeAI : MonoBehaviour, ITakeDamage, IPlayerRespawnListener
{
